...
class MAX30100(object):
    ...
    def set_led_current(self, led_current_red=11.0, led_current_ir=11.0):
        ...
        self.write_byte_data(I2C_ADDRESS, LED_CONFIG, chr(
            (led_current_red << 4) | led_current_ir))

    def set_mode(self, mode):
        reg = self.read_byte_data(I2C_ADDRESS, MODE_CONFIG)
        self.write_byte_data(I2C_ADDRESS, MODE_CONFIG,
                             chr(reg & 0x74))  # mask the SHDN bit
    ...
    def enable_interrupt(self, interrupt_type):
        ...
        self.write_byte_data(I2C_ADDRESS, INT_ENABLE,
                             chr((interrupt_type + 1) << 4))
